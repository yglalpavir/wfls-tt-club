...
const i18n = {
    zh: {
        ...
        wtt_pp_open: "打开个人页", wtt_pp_back: "返回个人数据", wtt_pp_hero: "WTT 球员个人数据页", wtt_pp_loading: "正在加载球员数据...", wtt_pp_no_player: "未找到该球员", wtt_pp_load_fail: "数据加载失败，请刷新重试", wtt_pp_refresh: "刷新页面", wtt_pp_view_records: "查看全部比赛记录",
