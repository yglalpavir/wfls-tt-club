#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""为 2003 年 ITTF 赛事（13 站）球员补充 assoc.json 协会籍记录（MS/WS）。"""
import json
import os
import re
...
# 复用 import_2003 的标准名映射
_spec = importlib.util.spec_from_file_location("imp2003", os.path.join(BASE_DIR, "import_2003.py"))
...
if __name__ == "__main__":
    print("补充 assoc.json (2003 十三站赛事)")
    add_to_assoc("ms")
    add_to_assoc("ws")