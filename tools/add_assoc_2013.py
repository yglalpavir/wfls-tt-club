#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""为 2013 年 ITTF 赛事（17 站）球员补充 assoc.json 协会籍记录（MS/WS）。

覆盖：MS/WS + U21MS/U21WS（一并导入 ms/ws）+ 世乒团体 MT/WT 单打。
...
# 复用 import_2013 的标准名映射
_spec = importlib.util.spec_from_file_location("imp2013", os.path.join(BASE_DIR, "import_2013.py"))
...
if __name__ == "__main__":
    print("补充 assoc.json (2013 十七站赛事)")
    add_to_assoc("ms")
    add_to_assoc("ws")