...
# -*- coding: utf-8 -*-
"""
WTT Grand Smash Malmo 2026 - MS/WS SF 补录 + MD Final 数据录入
日期 2026-08-15（用户标注：8-15）
...
additions = {
    "ms": [
        ("Sora MATSUSHIMA", "Elias RANEFUR"),
    ],
    "ws": [
        ("Miwa HARIMOTO", "CHEN Yi"),
    ],
    "md": [
        ("Alexis LEBRUN/Felix LEBRUN", "WONG Chun Ting/CHAN Baldwin"),
    ],
}
...
def main():
    print("=" * 60)
    print(f"WTT Grand Smash Malmo 2026 - MS/WS SF + MD Final [{DATE}]")
    print("=" * 60)
    for category in ["ms", "ws", "md"]:
