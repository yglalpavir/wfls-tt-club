#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""为 2002 年 ITTF 赛事（10 站）球员补充 assoc.json 协会籍记录（MS/WS）。"""
import json
import os
import re
...
# 复用 import_2002 的标准名映射
_spec = importlib.util.spec_from_file_location("imp2002", os.path.join(BASE_DIR, "import_2002.py"))
...
COUNTRY_MAP = {
    ...
    "GUA": "Guatemala", "HKG": "Hong Kong, China", "HON": "Honduras", "HUN": "Hungary",
    "IND": "India", "ISR": "Israel", "ITA": "Italy", "JOR": "Jordan", "JPN": "Japan",
...
def extract_players(cat):
    """从全部原始文件提取 原始名 -> 国家代码集合（仅 MS/WS，兼容断行）。"""
    players = {}
