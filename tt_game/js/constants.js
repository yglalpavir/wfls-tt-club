...
const STANCE = {               // 正/反手自动切换（simcore.js#resolveStance 单一逻辑源）
  ...
  minHold: 0.15,               // 切换后最短保持 (s)：刚换握不马上切回（防抖 + 换握惯性）
  urgent: 1.1,                 // 紧急纠正：minHold 期内球明显在另一侧（|score|>urgent）仍允许改
  commitT: 0.15,               // 触球承诺窗口 (s)：TTC 小于此值锁姿态（挥拍已启动，真人也不会再换）
